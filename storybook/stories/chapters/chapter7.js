...
storiesOf('CHAPTER 7: Open Source ❤️ Storybook')
  ...
  .add('2. Storybook before Open Source Community', () => (
    <ImageWithTitle
      ...
      image={
        images[select('Image', Object.keys(images), 'beforeContributions')]
      }
    />
  ))
  .add('3. Storybook now', () => (
  ...
  .add('4. Wix Quote', () => (
    <View flex marginH-100>
    <LongQuote
      title={text(
        'title',
        'Knowledge sharing, contributing to the community, and promoting Open Source projects, is part of our culture at Wix Engineering.',
      )}
      h2
    />
    </View>
